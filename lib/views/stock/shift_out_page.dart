...
class ShiftOutPage extends StatefulWidget {
  var FBillNo;
  var tranType;
  ShiftOutPage({Key ?key, @required this.FBillNo, @required this.tranType}) : super(key: key);

  @override
  _ShiftOutPageState createState() => _ShiftOutPageState(FBillNo, tranType);
}

class _ShiftOutPageState extends State<ShiftOutPage> {
  ...
  _ShiftOutPageState(FBillNo,tranType) {
      ...
      if(number == 0 && this.fBillNo ==""){
        ...
        arr.add({
          ...
          "value": {
            ...
            "rateValue": materialDate["remainQty"],
