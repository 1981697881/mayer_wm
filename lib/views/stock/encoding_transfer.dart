...
class EncodingTransfer extends StatefulWidget {
  var FBillNo;
  var tranType;
  EncodingTransfer({Key ?key, @required this.FBillNo, @required this.tranType}) : super(key: key);

  @override
  _EncodingTransferState createState() => _EncodingTransferState(FBillNo, tranType);
}

class _EncodingTransferState extends State<EncodingTransfer> {
  ...
  _EncodingTransferState(FBillNo, tranType) {
  ...
  void initState() {
    ...
    getStockList();
    //_onEvent("GD08001;;;600;;0657259425;0;1");
    //getDepartmentList();
    //getBillNo();
    //_onEvent("ldsFGcTl");
  }
