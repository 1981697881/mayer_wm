...
class _StockPageState extends State<StockPage> {
  ...
  getOrderList(keyWord, batchNo, fSn) async {
    ...
    userMap['pageNum'] = 1;
    userMap['pageSize'] = 50;
    var saveData = jsonEncode(userMap);
      ...
      if (orderDate.length > 0) {
        for (var value in orderDate) {
          ...
          arr.add({
            "title": "库位",
            "name": "FStockIdFName",
            "value": {"label": value['FStockPlacename'] == null?'':value['FStockPlacename'], "value": value['FStockPlacename'] == null?'':value['FStockPlacename']}
          });
          arr.add({
            "title": "进数量",
            "name": "FBaseQty",
            "value": {"label": value['FBCInQty'], "value": value['FBCInQty']}
          });arr.add({
            "title": "出数量",
            "name": "FBaseQty",
            "value": {"label": value['FBCOutQty'], "value": value['FBCOutQty']}
          });arr.add({
            "title": "剩余数量",
            "name": "FBaseQty",
            "value": {"label": value['FBarcodeQty'], "value": value['FBarcodeQty']}
          });
          arr.add({
            "title": "库存数量",
            "name": "FBaseQty",
          ...
          arr.add({
            "title": "批号",
            "name": "FBatchNo",
            "value": {"label": value['FBatchNo'] == null?'':value['FBatchNo'], "value": value['FBatchNo'] == null?'':value['FBatchNo']}
          });
          hobby.add(arr);
        };
        setState(() {
