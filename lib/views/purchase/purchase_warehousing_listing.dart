...
class PurchaseWarehousingListing extends StatefulWidget {
  var FBillNo;
  var tranType;

  PurchaseWarehousingListing(
      {Key? key, @required this.FBillNo, @required this.tranType})
      : super(key: key);

  @override
  _PurchaseWarehousingListingState createState() =>
      _PurchaseWarehousingListingState(FBillNo, tranType);
}

class _PurchaseWarehousingListingState
    extends State<PurchaseWarehousingListing> {
  ...
  final _positionContent = new TextEditingController();
  final _labelContent = new TextEditingController();
                        ...
                        child: ListTile(
                          ...
                          title: TextField(
                            decoration: InputDecoration(
                                labelText: "库位", border: OutlineInputBorder()),
