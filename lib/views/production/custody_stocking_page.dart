...
import 'package:mayer_wm/views/production/picking_detail.dart';
import 'package:mayer_wm/views/production/picking_picking.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:shared_preferences/shared_preferences.dart';

import 'custody_stocking_detail.dart';

class CustodyStockingPage extends StatefulWidget {
  var tranType;
  CustodyStockingPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _CustodyStockingPageState createState() => _CustodyStockingPageState(tranType);
}

class _CustodyStockingPageState extends State<CustodyStockingPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  _CustodyStockingPageState(tranType) {
