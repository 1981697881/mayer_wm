...
class PickingPicking extends StatefulWidget {
  var FBillNo;
  var tranType;

  PickingPicking({Key? key, @required this.FBillNo, @required this.tranType})
      : super(key: key);

  @override
  _PickingPickingState createState() =>
      _PickingPickingState(FBillNo, tranType);
}

class _PickingPickingState extends State<PickingPicking> {
