...
import 'custody_warehousing_detail.dart';
import 'custody_warehousing_listing.dart';

class CustodyWarehousingPage extends StatefulWidget {
  var tranType;
  CustodyWarehousingPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _CustodyWarehousingPageState createState() => _CustodyWarehousingPageState(tranType);
}

class _CustodyWarehousingPageState extends State<CustodyWarehousingPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  _CustodyWarehousingPageState(tranType) {
                        ...
                        builder: (BuildContext context) {
                          return new Column(
                            ...
                            children: <Widget>[
                              new ListTile(
                                ...
                                onTap: () async {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) {
                                        return CustodyWarehousingDetail(
                              ...
                              divider,
                              new ListTile(
                                title: new Center(child: new Text("上架")),
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) {
                                        return CustodyWarehousingListing(
                                            FBillNo: this.hobby[i][0]['value'],
                                            tranType: this.tranType
                                          // 路由参数
                                        );
