...
import 'package:mayer_wm/views/production/stock_up_packing.dart';
import 'package:mayer_wm/views/production/stock_up_picking.dart';
import 'package:mayer_wm/views/production/stock_up_tallying.dart';
import 'package:mayer_wm/views/purchase/purchase_warehousing_listing.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:shared_preferences/shared_preferences.dart';

class StockUpPage extends StatefulWidget {
  var tranType;
  StockUpPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _StockUpPageState createState() => _StockUpPageState(tranType);
}

class _StockUpPageState extends State<StockUpPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
                    ...
                    /*showModalBottomSheet(
                        ...
                        builder: (BuildContext context) {
                          return new Column(
                            ...
                            children: <Widget>[
                              new ListTile(
                                title: new Center(child: new Text("拣货")),
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                              ...
                              divider,
                              new ListTile(
                                title: new Center(child: new Text("装箱")),
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) {
                                        return StockUpPacking(
                                            FBillNo: this.hobby[i][0]['value'],
                                            tranType: this.tranType
                                          // 路由参数
                                        );
                              ...
                              new ListTile(
                                title: new Center(child: new Text("理货")),
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) {
                                        return StockUpTallying(
                                            FBillNo: this.hobby[i][0]['value'],
                                            tranType: this.tranType
                                          // 路由参数
                                        );
