...
class CustodyReturnPage extends StatefulWidget {
  var FBillNo;
  var tranType;

  CustodyReturnPage({Key? key, @required this.FBillNo, @required this.tranType})
      : super(key: key);

  @override
  _CustodyReturnPageState createState() =>
      _CustodyReturnPageState(FBillNo, tranType);
}

class _CustodyReturnPageState extends State<CustodyReturnPage> {
