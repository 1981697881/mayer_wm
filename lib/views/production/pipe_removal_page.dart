...
import 'package:mayer_wm/views/production/pipe_removal_detail.dart';
import 'package:mayer_wm/views/purchase/purchase_warehousing_listing.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:shared_preferences/shared_preferences.dart';

class PipeRemovalPage extends StatefulWidget {
  var tranType;
  PipeRemovalPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _PipeRemovalPageState createState() => _PipeRemovalPageState(tranType);
}

class _PipeRemovalPageState extends State<PipeRemovalPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  _PipeRemovalPageState(tranType) {
