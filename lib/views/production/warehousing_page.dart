...
import 'package:mayer_wm/views/production/warehousing_detail.dart';
import 'package:mayer_wm/views/production/warehousing_listing.dart';
    ...
    if (orderDate.length > 0) {
      for(var value in orderDate){
        ...
        arr.add({
          ...
          "name": "FMaterial",
          "isHide": false,
           "value": {"label": value['FPrdItemName'] + "- (" + value['FPrdItemNumber'] + ")", "value": value["FPrdItemNumber"]}
        });
        arr.add({
          "title": "规格型号",
        ...
        arr.add({
          ...
          "name": "FUnitId",
          "isHide": false,
          "value": {"label": value["FPrdUnitName"], "value": value["FPrdUnitNumber"]}
        });
        arr.add({
          "title": "数量",
          "name": "FQty",
          "isHide": false,
          "value": {"label": value["FPrdQty"], "value": value["FPrdQty"]}
        });
        hobby.add(arr);
      }
      };
