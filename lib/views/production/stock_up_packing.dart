...
class StockUpPacking extends StatefulWidget {
  var FBillNo;
  var tranType;
  ...
  @override
  _StockUpPackingState createState() =>
      _StockUpPackingState(FBillNo, tranType);
}

class _StockUpPackingState
    extends State<StockUpPacking> {
    ...
    if (materialDate != null) {
      ...
      if (number == 0) {
        ...
        arr.add({
          ...
          "isHide": false,
          "value": {
            "label": materialDate['quantity'].toString(),
            "value": materialDate['quantity'].toString()
          }
        });
        arr.add({
          "title": "已打标签",
