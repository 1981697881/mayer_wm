...
class CustodyStockingDetail extends StatefulWidget {
  var FBillNo;
  var tranType;

  CustodyStockingDetail(
      {Key? key,
  ...
  @override
  _CustodyStockingDetailState createState() => _CustodyStockingDetailState(
      FBillNo, tranType);
}

class _CustodyStockingDetailState extends State<CustodyStockingDetail> {
  ...
  _CustodyStockingDetailState(
    ...
    if (FBillNo != null) {
      ...
      isScanWork = false;
      this.fBillNo = '';
     //_onEvent("PGS11A1070611;;;15;;2300015974;0;1");
    }
  }
