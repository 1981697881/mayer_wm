...
class CustodyWarehousingListing extends StatefulWidget {
  var FBillNo;
  var tranType;

  CustodyWarehousingListing(
      {Key? key, @required this.FBillNo, @required this.tranType})
      : super(key: key);

  @override
  _CustodyWarehousingListingState createState() =>
      _CustodyWarehousingListingState(FBillNo, tranType);
}

class _CustodyWarehousingListingState
    extends State<CustodyWarehousingListing> {
