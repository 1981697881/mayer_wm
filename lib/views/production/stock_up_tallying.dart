...
class StockUpTallying extends StatefulWidget {
  var FBillNo;
  var tranType;

  StockUpTallying({Key? key, @required this.FBillNo, @required this.tranType})
      : super(key: key);

  @override
  _StockUpTallyingState createState() =>
      _StockUpTallyingState(FBillNo, tranType);
}

class _StockUpTallyingState extends State<StockUpTallying> {
      ...
      this.hobby.forEach((element) {
        if (element[3]['value']['value'] != '0') {
          ...
          for (int subj = 0; subj < kingDeeCode.length; subj++) {
            ...
            FEntityItem['tranType'] = this.tranType;
