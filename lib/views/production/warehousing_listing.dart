...
class WarehousingListing extends StatefulWidget {
  var FBillNo;
  var tranType;
  ...
  @override
  _WarehousingListingState createState() =>
      _WarehousingListingState(FBillNo, tranType);
}

class _WarehousingListingState
    extends State<WarehousingListing> {
  ...
  getMaterialList(barcodeData, code, str) async {
    ...
    if (materialDate != null) {
      ...
      for (var value in orderDate) {
        if (value['FPrdItemNumber'] == materialDate['number'] ) {//&& value['FItemNumber'] == materialDate['location']
          msg = "";
