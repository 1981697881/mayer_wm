...
class PipeShelvingPage extends StatefulWidget {
  var FBillNo;
  var tranType;
  ...
  @override
  _PipeShelvingPageState createState() =>
      _PipeShelvingPageState(FBillNo, tranType);
}

class _PipeShelvingPageState
    extends State<PipeShelvingPage> {
  ...
  getMaterialList(barcodeData, code, str) async {
    ...
    if (materialDate != null) {
      ...
      if (this.fBillNo == '') {
        this.fBillNo = materialDate["billNo"];
      }
                        ...
                        child: ListTile(
                          title: TextField(
                            decoration: InputDecoration(
                                labelText: "库别/库位", border: OutlineInputBorder()),
