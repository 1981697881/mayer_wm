...
import 'package:mayer_wm/views/production/warehousing_confirm_detail.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:shared_preferences/shared_preferences.dart';

final String _fontFamily = Platform.isWindows ? "Roboto" : "";

class WarehousingConfirmPage extends StatefulWidget {
  var tranType;
  WarehousingConfirmPage({Key ?key,@required this.tranType}) : super(key: key);

  @override
  _WarehousingConfirmPageState createState() => _WarehousingConfirmPageState(tranType);
}

class _WarehousingConfirmPageState extends State<WarehousingConfirmPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  _WarehousingConfirmPageState(tranType) {
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return WarehousingConfirmDetail(
